...
- simple-erp-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- simple-erp-ui: main application module, development time
- simple-erp-production: module that produces a production mode WAR for deployment
